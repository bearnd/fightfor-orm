...
Vagrant.configure("2") do |config|
    ...
    config.vm.synced_folder ".", "/home/vagrant/fightfor-orm"

    config.vm.define "fform" do |fform|
        # define virtualization provider
        fform.vm.provider "virtualbox"
        # define box
        fform.vm.box = "bento/ubuntu-16.04"
    ...
    config.vm.provision :ansible do |ansible|
        ansible.playbook = "app-fightfor-orm.yml"
